...
def run_for_video(video_path: Path, step: int | None = None):
    ...
    if step is None or step == 1:
        ...
        print("[1/3] Extracting world coordinates...")
        s1.main()
    ...
    if step is None or step == 2:
        ...
        print("[2/3] Converting world → quaternions...")
        s2.main()
    ...
    if step is None or step == 3:
        ...
        print("[3/3] Converting quaternions → Rodrigues...")
        s3.main()
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run the FRI Handover pipeline (steps 1–3).")
    parser.add_argument("--step", type=int, choices=[1, 2, 3],
                        help="Run only this specific step (1–3). Default runs all.")
    ...
    print("FRI Handover — Pipeline Runner")
