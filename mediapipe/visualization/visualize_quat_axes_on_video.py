...
# --- CONFIGURATION ---
INPUT_VIDEO = '1_bhavana_final_neel_final.mkv' # !! REMEMBER TO UPDATE THIS PATH !!
...
# # --- CONFIGURATION ---
# INPUT_VIDEO = 'demo-content/output_with_hands.mp4' # !! REMEMBER TO UPDATE THIS PATH !!OUTPUT_VIDEO = 'outputs/video_with_triple_axes.mp4'
